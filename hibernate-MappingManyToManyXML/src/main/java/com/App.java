...
public class App {
	...
	public void addStudent() {
		...
		try {
			...
			/**
			 * Correct code because we have inverse="true" in Subject.hbm.xml
			 */
...
//			
			...
			/**
			 * Wrong code because we have inverse="true" in Subject.hbm.xml
			 * It save only data of STUDENT and SUBJECT tables, not data in STUDENT_SUBJECT table.
			 */
